...
echo"6.  Utilizando a dica nessa resposta, calcular o tempo de atraso total para a companhia Delta Air Lines."
echo "Não esquecer de filtrar linhas com dados faltando e também com valores negativos (casos em que os vôos são adiantados)"
